  ...
  return <StorefrontLayout site={site} illustrativeMedia={illustrativeMedia}>
    <main className="app-tienda-main storefront-container" id="contenido">
      ...
      {result && <div ref={receiptContainer} tabIndex={-1}>
        {managingResult ? <GuestManagement key={result.receipt.reference} site={site} api={api} token={result.managementToken} /> : <><BookingReceipt key={result.receipt.reference} site={site} api={api} initial={result.receipt} token={result.receiptToken} managementToken={result.managementToken} />
